                ...
                <div className={styles.content}>
                    <div className={`${styles.records} ${activeTurnTab === "tabSide" ? "" : styles.records_unactive}`}>
                        ...
                        <div className={`${styles.record} ${((activeLengthTab === "tabEntireLength") || (activeLengthTab === "tabHalf")) ? "" : styles.record_unactive}`}>
                            <span>{(auth && recordData.freestyle?.[0].side_25 !== '') ? recordData.freestyle?.[0].side_25 : " - "}</span>
                        </div>
                        <div className={`${styles.record} ${((activeLengthTab === "tabEntireLength") || (activeLengthTab === "tabFull")) ? "" : styles.record_unactive}`}>
                            <span>{(auth && recordData.freestyle?.[0].side_50 !== '') ? recordData.freestyle?.[0].side_50 : " - "}</span>
                        </div>
                    </div>
                    <div className={`${styles.records} ${activeTurnTab === "tabFlip" ? "" : styles.records_unactive}`}>
                        ...
                        <div className={`${styles.record} ${((activeLengthTab === "tabEntireLength") || (activeLengthTab === "tabHalf")) ? "" : styles.record_unactive}`}>
                            <span>{(auth && recordData.freestyle?.[0].flip_25 !== '') ? recordData.freestyle?.[0].flip_25 : " - "}</span>
                        </div>
                        <div className={`${styles.record} ${((activeLengthTab === "tabEntireLength") || (activeLengthTab === "tabFull")) ? "" : styles.record_unactive}`}>
                            <span>{(auth && recordData.freestyle?.[0].flip_50 !== '') ? recordData.freestyle?.[0].flip_50 : " - "}</span>
                        </div>
                    </div>
                    <div className={`${styles.records} ${activeTurnTab === "tabStart" ? "" : styles.records_unactive}`}>
                        ...
                        <div className={`${styles.record} ${((activeLengthTab === "tabEntireLength") || (activeLengthTab === "tabHalf")) ? "" : styles.record_unactive}`}>
                            <span>{(auth && recordData.freestyle?.[0].start_25 !== '') ? recordData.freestyle?.[0].start_25 : " - "}</span>
                        </div>
                        <div className={`${styles.record} ${((activeLengthTab === "tabEntireLength") || (activeLengthTab === "tabFull")) ? "" : styles.record_unactive}`}>
                            <span>{(auth && recordData.freestyle?.[0].start_50 !== '') ? recordData.freestyle?.[0].start_50 : " - "}</span>
                        </div>
                    </div>
                    <div className={`${styles.records} ${activeTurnTab === "tabFin" ? "" : styles.records_unactive}`}>
                        ...
                        <div className={`${styles.record} ${((activeLengthTab === "tabEntireLength") || (activeLengthTab === "tabHalf")) ? "" : styles.record_unactive}`}>
                            <span>{(auth && recordData.freestyle?.[0].fin_25 !== '') ? recordData.freestyle?.[0].fin_25 : " - "}</span>
                        </div>
                        <div className={`${styles.record} ${((activeLengthTab === "tabEntireLength") || (activeLengthTab === "tabFull")) ? "" : styles.record_unactive}`}>
                            <span>{(auth && recordData.freestyle?.[0].fin_50 !== '') ? recordData.freestyle?.[0].fin_50 : " - "}</span>
                        </div>
                    </div>
                </div>
            ))}
